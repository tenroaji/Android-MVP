...
import lagecong.com.mvp.slider.model.SliderInterface;
...
public final class Slider {
     ...
     */
    @NonNull
    public static SliderInterface attach(@NonNull Activity activity) {
     ...
     */
    @NonNull
    public static SliderInterface attach(@NonNull Activity activity, @ColorInt int statusBarColor1,
     ...
     */
    @NonNull
    public static SliderInterface attach(@NonNull Activity activity, @NonNull SliderConfig config) {
     ...
     */
    @NonNull
    private static SliderPanel attachSliderPanel(@NonNull Activity activity, @NonNull SliderConfig config) {
     ...
     */
    @NonNull
    public static SliderInterface replace(@NonNull final View oldScreen, @NonNull final SliderConfig config) {
